    ...
    <div className="bg-[#121212] min-h-[60vh] ">
      <div className="max-w-7xl mx-auto">
        <div className="flex justify-between items-center">
          <h1 className="text-5xl font-semibold py-20">Subscribe our Newsletter and get <br /> all of our update</h1>
          <div className="relative ">
            <input type="text" className="border rounded-full px-10 w-lg py-6 " placeholder="Enter Email" />
        ...
        <div className="grid grid-cols-5 py-20" id="footer-manu">
      ...
      <div className="border-t border-gray-600 py-5">
        <div className=" flex justify-between max-w-7xl mx-auto">
          <h1>© 2025, Elexy Shopify Theme</h1>
