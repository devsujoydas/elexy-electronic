...
const SmartGrid = () => {
    return (
        <div className='bg-white'>
            <div className='md:w-7xl md:mx-auto mx-5 py-20 grid md:grid-cols-3 grid-cols-1  gap-5'>

                <div className='overflow-hidden  md:col-span-1   rounded-2xl cursor-pointer relative'>
