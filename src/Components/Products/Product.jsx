...
const Product = ({ product }) => {
    ...
    return (
        <div className="rounded-2xl shadow shadow-white hover:-translate-y-1 transition-all duration-500 overflow-hidden w-fit">
            <button className="cursor-pointer grid gap-2 text-left">
                <div className="overflow-hidden">
                    <img className="hover:scale-110 duration-500 transition-all w-xs" src={img[0]} alt="" />
                </div>
